...
document.addEventListener('DOMContentLoaded', function() {
    const toggleButtons = document.querySelectorAll('.toggle-gpt-list');

    toggleButtons.forEach(button => {
        const containerId = button.dataset.target;
        const container = document.getElementById(containerId);
        const gptItems = container.querySelectorAll('.gpt-item');
        const itemsToHide = Array.from(gptItems).slice(5); // 6番目以降のアイテムを取得

        // 最初は最初の5つ以降のアイテムを非表示にする
        itemsToHide.forEach(item => {
            item.classList.add('hidden-gpt');
        });

        button.addEventListener('click', function() {
            if (this.textContent === 'もっと見る') {
                itemsToHide.forEach(item => {
                    item.classList.remove('hidden-gpt');
                });
                ...
                // (オプション) 折りたたんだときにコンテナの先頭にスクロールバックする
...
<h2 id="public">滋賀大学のオリジナルGPTs (全体公開用)</h2>
<div class="gpt-list-container" id="public-gpt-list">
    <div class="gpt-item">
        ...
        <p>大学内で行われるイベントを紹介します。（セミナー、公開講座など）</p>
        <p>作成者: Oishi Yuta</p>
    </div>
    <div class="gpt-item">
        ...
        <p>滋賀大彦根キャンパスのキッチンカーについて教えてくれます。</p>
        <p>作成者: NANJO, Hiroaki</p>
    </div>
    <div class="gpt-item">
        ...
        <p>非負値行列因子分解（NMF）に関する質問に日本語で答える専門家です。</p>
        <p>作成者: 佐藤健一</p>
    </div>
    <div class="gpt-item">
    ...
    <div class="gpt-item">
        ...
        <p>統計検定1級合格のための練習の問題を出そうとしています。</p>
        <p>作成者: NANJO, Hiroaki</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>滋賀大学データサイエンス研究科の大学院生が適切なゼミ、指導教員を選ぶための相談役です。</p>
        <p>作成者: 寺口俊介</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>Helps with queries about Shiga University</p>
        <p>作成者: Osamu Ichikawa</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>Pythonのpydatasetに含まれる約750個のデータセットから目的に応じたものを提案します。</p>
        <p>作成者: 佐藤健一</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>冷蔵庫画像から食材と鮮度・量を読み取り、目的別レシピと保存アドバイスを提案します。</p>
        <p>作成者: 岡田大輝</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>滋賀大学大学院データサイエンス研究科の研究室を紹介をするGPTです。</p>
        <p>作成者: 宮田尚弥</p>
    </div>
    <div class="gpt-item hidden-gpt">
    ...
    <div class="gpt-item hidden-gpt">
        ...
        <p>小学校３年生の児童に適した、教育的で楽しい会話を提供します。</p>
        <p>作成者: Hirofumi SAITO</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>滋賀大学データサイエンス学部のゼミ紹介をするGPTです。</p>
        <p>作成者: 三田村洸明</p>
    </div>
    <div class="gpt-item hidden-gpt">
    ...
    <div class="gpt-item hidden-gpt">
        ...
        <p>どのような部活・サークルをお探しですか？お手伝いします！</p>
        <p>作成者: 福山太陽</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>滋賀大学データサイエンス研究科の教師なし学習（寺口担当分）のティーチングアシスタントです。</p>
        <p>作成者: 寺口俊介</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>関数データ解析の専門家として講義資料とRコードに基づき質問に回答します。</p>
        <p>作成者: Hidetoshi Matsui</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>Gpt gives us ideas of dishes.</p>
        <p>作成者: Moto Tanaka</p>
    </div>
    <button class="toggle-gpt-list" data-target="public-gpt-list">もっと見る</button>
</div>

---

<h2 id="research-group">滋賀大学のオリジナルGPTs (研究会製作)</h2>
<div class="gpt-list-container" id="research-gpt-list">
    <div class="gpt-item">
        ...
        <p>滋賀大生の将来の夢を入力されるとそれに資する授業を提案します。</p>
        <p>作成者: K.Kawasaki</p>
    </div>
    <div class="gpt-item">
        <a href="https://chatgpt.com/g/g-684f70191a108191b5237dacf243ecc7-dsyan-jiu-ke-yan-jiu-shi-shao-jie-fei-gong-shi-zi-zhu-semitezuo-cheng" target="_blank">
    ...
    <div class="gpt-item">
        ...
        <p>Suggests and explains recipes based on your fridge photos.</p>
        <p>作成者: Moto Tanaka</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>滋賀大学生向けマッチング支援GPT。対話入力で匿名登録＆スプレッドシート連携。</p>
        <p>作成者: Suzuki Reo</p>
    </div>
    <div class="gpt-item hidden-gpt">
        <a href="https://chatgpt.com/g/g-6821575e3e608191b8fcc2262eab20aa-resihikamera" target="_blank">
        ...
        <p>冷蔵庫画像から食材と鮮度・量を読み取り、目的別レシピと保存アドバイスを提案</p>
        <p>作成者: 岡田大輝</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>講義資料のPDFをアップロードすると、その資料に出てくる数式を、まず講義の流れを押さえてから、記号の意味→パーツごとの構造→全体の意味→図解という順でわかりやすく解説します。文系出身や社会人学生のためのやさしいサポートに特化しています。</p>
        <p>作成者: 宮田尚弥</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>大学内で行われるイベントを紹介します。（就職関係、留学関係、セミナー関係、団体関係など）</p>
        <p>作成者: Oishi Yuta</p>
    </div>
    <div class="gpt-item hidden-gpt">
        ...
        <p>英語学習スクール『株式会社 English Buffet』の情報をHP(https://englishbuffet.net/)以下より参照、返信</p>
        <p>作成者: 岸田洋明</p>
    </div>
    <button class="toggle-gpt-list" data-target="research-gpt-list">もっと見る</button>
</div>
